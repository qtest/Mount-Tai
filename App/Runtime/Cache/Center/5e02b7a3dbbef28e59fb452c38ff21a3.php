...
$(document).ready(function(){
	...
	initDataGrid("tbl","后加工工序列表","<?=U('Process/getAll4Json')?>","#dbTool");
});
...
function submitForm(type){
	...
	new Maya.Box({
		text : "后加工工序"+title,
		url : "<?=U ( "Process/actionCheckIndex" )?>/type/"+type+"/id/"+id,
		win : parent,
		width : 600,
		height : 220,
		btns : [
...
function  del(){
	...
	new Maya.Box({
		text : "删除记录",
		chtml : "<b>确定要删除以下工序信息？</b><br />"+title+"",
		win : parent,
		isAlert : true,
		iframeAuto : false,
		overlayAlpha : .5,
...
<div id="dbTool">
		...
		<a href="#" id="btndel" class="easyui-linkbutton" iconCls="icon-perf" plain="true" onclick="updateAttr()">可选项设置</a>
...
<div class="content">
	<table id="tbl">
		<thead>
			<tr>
				<th field="p_name" width="120" align="left"><strong>工序名称</strong></th>
				<th field="p_status" width="40" align="center" formatter="formatStatus"><strong>状态</strong></th>
				<th field="total" width="60" align="center"><strong>可选项数</strong></th>
				<th field="p_unit" width="60" align="center"><strong>单位</strong></th>
				<th field="combo_name" width="60" align="center"><strong>组合名称</strong></th>
				<th field="ismust" width="60" align="center" formatter="formatDIY"><strong>必选</strong></th>
				<th field="sizeDIY" width="60" align="center" formatter="formatDIY"><strong>尺寸自定义</strong></th>
				<th field="numDIY" width="60" align="center" formatter="formatDIY"><strong>数量自定义</strong></th>
				<th field="hasDesc" width="60" align="center" formatter="formatDIY"><strong>附加说明</strong></th>
				<th field="p_price" width="80" align="center"><strong>单价</strong></th>
				<th field="p_minFee" width="80" align="center"><strong>起步价</strong></th>
				<th field="p_otherFee" width="80" align="center"><strong>其它费用</strong></th>
				<th field="p_lastDate" width="150" align="center"><strong>更新时间</strong></th>
			</tr>
		</thead>
	</table>
</div>
