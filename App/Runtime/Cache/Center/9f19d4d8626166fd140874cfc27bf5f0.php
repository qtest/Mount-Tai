...
$(document).ready(function(){
	...
	initDataGrid("tbl","系统用户列表","<?=U('Manager/getDataGridData4ManagerList')?>","#dbTool");
});
...
function filterData(type){
	...
	$.post(
			"<?=U('Manager/getDataGridData4ManagerList')?>",
			{
				type:type,
				g_name:g_name,
				u_name:u_name,
...
function managerEdit(){
	...
	new Maya.Box({
		text : "用户信息修改",
		url : "<?=U ( "Manager/managerEdit" )?>/id/"+id,
		win : parent,
		width : 600,
		height : 220,
		btns : [
...
<div id="dbTool">
	<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="managerAdd()">添加</a>
	<a href="#" id="btnedit" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="managerEdit()">修改</a>
	<a href="#" id="btndel" class="easyui-linkbutton" iconCls="icon-cancel" plain="true" onclick="delManager()">删除</a>|
	<a href="#" id="btndel" class="easyui-linkbutton" iconCls="icon-checkOk" plain="true" onclick="checkManagerInfo()">审核</a>
	<a href="#" id="btndel" class="easyui-linkbutton" iconCls="icon-checkOk" plain="true" onclick="managerManey()">会员账户</a>
...
<div class="content">
	...
	<table id="tbl" data-options="singleSelect:true">
		<thead>
			<tr>
				<th field="u_name" width="120" align="left"><strong>员工名称</strong></th>
				<th field="g_name" align="left" width="70"><strong>用户组</strong></th>
				<th field="u_status" align="center" width="40" formatter="formatStatus"><strong>状态</strong></th>
				...
				<th field="u_maney" width="130" align="center"><strong>账户/可用</strong></th>
