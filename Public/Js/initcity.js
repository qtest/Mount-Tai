...
function pc_init(){
	...
	if(province && city){
		_creatprovince(province,city);	
		province.onchange = function(){
			_initcity(province, city);
			if(typeof(selectpro)=="function"){selectpro(province);} //后修改加入取值
		};
	}
}
...
function _initcity(province, city) {
    switch (province.value) {
        ...
        case "海外" :
            ...
            break;
        default:
            var cityOptions = new Array("请选择省份", "");
            break;
    }
...
function _creatprovince(province,city){
	...
	city.options[0]=new Option("请选择省份","");
